module.exports = {
	...
	defaultVolume: 60, //- Sets the default volume of the bot, You can change this number anywhere from 1 to 100
	supportServer: "https://discord.gg/dG5rtPF7", //- Support Server Link
	...
	cookieSecret: "sentisie's team", //- Cookie Secret
	...
	presence: {
		...
		activities: [
			{
				name: "/help - Best SoundCloud bot", //- Status Text
